...
public class PharmApp extends JFrame implements ActionListener {
    private JLabel Cashier, MonitorHead, Header,FootageHolder, Header2,logo3Holder,logo3HolderText,closeMsg,OpenMsg;
...
//    drug2 .
    ...
    private double Vat;
    private AddProducts RecentProduct;

    protected String AddingProduct="";
    protected double AddPrices=0.0;
...
//        try{
//            BufferedReader StoreDrugs = new BufferedReader(new FileReader("src/PharmacyApp/Assets/DrugList.txt"));
//            String line=null;
...
//        try{
//            BufferedReader PriceList = new BufferedReader(new FileReader("src/PharmacyApp/Assets/PriceList.txt"));
...
//        }
        ...
        logo3HolderText.setBounds(350,400,1000,200);
...
//        ImageMonitor.add();
        ...
        logo3Holder.setBounds(500,300,200,200);
    ...
    public void actionPerformed(ActionEvent e) {
       ...
       if (e.getSource() == btn1) {
            ...
            try {
                ...
                FileOutputStream Selected = new FileOutputStream("C:/Users/M/Desktop/nou2023/JavaTesting/coreJava/src/MultiThreading/DrugsFile.txt",true);
               String chose ="\n"+(String) ProductList.getSelectedValue()+date;
               Selected.write(chose.getBytes(StandardCharsets.UTF_8));
               Selected.close();
...
//                total+=(Prices.get(ProductList.getSelectedIndex()));
           ...
           display.setEnabled(true);
            ...
            RecentProduct.PriceText.getText();
